document.getElementById("cartbutton").addEventListener("click", function() {
    window.location.href = "cart.html"; // Replace "newpage.html" with the path to your new HTML page
  });
  document.getElementById("menuquench").addEventListener("click", function() {
    window.location.href = "menuquench.html"; // Replace "newpage.html" with the path to your new HTML page
  });
