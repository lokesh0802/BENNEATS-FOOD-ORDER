        ...
        <div className="py-3 px-10 sm:px-4 md:px-6 lg:px-6 container mx-auto">
            <div className=" flex  items-center justify-between ">
                ...
                <div className="lg:flex hidden gap-8 items-center">
                    <a href="" className="text-[#191919] text-xl font-meduim hover:text-red-500">Today Special</a>
                    <a href="" className="text-[#191919] text-xl font-meduim hover:text-red-500">Why Benneats</a>
                    <a href="" className="text-[#191919] text-xl font-meduim hover:text-red-500">Our Menu</a>
                    <a href="" className="text-[#191919] text-xl font-meduim hover:text-red-500">Add Food</a>
                    <a href="" className="text-[#191919] text-xl font-meduim hover:text-red-500">Best Seller</a>
